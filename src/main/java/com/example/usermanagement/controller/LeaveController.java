...
public class LeaveController {
    ...
    public ApiResponse<LeaveRequestDTO.Response> requestLeave(@Valid @RequestBody LeaveRequestDTO.Request request) {
        return ApiResponse.success(leaveService.requestLeave(request), "Leave request created successfully");
    }

    @PostMapping("/{id}/approve")
    public ApiResponse<LeaveRequestDTO.Response> approveLeave(@PathVariable UUID id) {
        return ApiResponse.success(leaveService.approveLeave(id), "Leave request approved successfully");
    }

    @PostMapping("/{id}/reject")
    public ApiResponse<LeaveRequestDTO.Response> rejectLeave(@PathVariable UUID id) {
        return ApiResponse.success(leaveService.rejectLeave(id), "Leave request rejected successfully");
    }

    @GetMapping("/balance/{employeeId}")
    public ApiResponse<LeaveBalanceDTO.Response> getLeaveBalance(
    ...
    public ApiResponse<List<LeaveRequestDTO.Response>> getLeaveRequests(
            @PathVariable UUID employeeId,
